# This is a symlinked file. Original source:
# ~/devSandbox/alz-accelerator/platform-landing-zone.tfvars

# --- Built-in Replacements ---
# This file contains built-in replacements to avoid repeating the same hard-coded values.
# Replacements are denoted by the dollar-dollar curly braces token (e.g. uks). The following details each built-in replacemnets that you can use:
...
custom_replacements = {
  ...
  names = {
    ...
    management_resource_group_name               = "rg-mgmt-uks"
    connectivity_hub_primary_resource_group_name = "rg-hub-uks"
    dns_resource_group_name                      = "rg-hub-dns-uks"
    ddos_resource_group_name                     = "rg-hub-ddos-uks"
    asc_export_resource_group_name               = "rg-asc-export-uks"

    # Resource names management
    log_analytics_workspace_name            = "law-mgmt-uks"
    ddos_protection_plan_name               = "ddos-uks"
    automation_account_name                 = "aa-mgmt-uks"
    ama_user_assigned_managed_identity_name = "uami-mgmt-ama-uks"
    dcr_change_tracking_name                = "dcr-change-tracking"
    dcr_defender_sql_name                   = "dcr-defender-sql"
    dcr_vm_insights_name                    = "dcr-vm-insights"

    # Resource names primary connectivity
    primary_virtual_network_name                                 = "vnet-hub-uks"
    primary_firewall_name                                        = "fw-hub-uks"
    primary_firewall_policy_name                                 = "fwp-hub-uks"
    primary_firewall_public_ip_name                              = "pip-fw-hub-uks"
    primary_route_table_firewall_name                            = "rt-hub-fw-uks"
    primary_route_table_user_subnets_name                        = "rt-hub-std-uks"
    primary_virtual_network_gateway_express_route_name           = "vgw-hub-er-uks"
    primary_virtual_network_gateway_express_route_public_ip_name = "pip-vgw-hub-er-uks"
    primary_virtual_network_gateway_vpn_name                     = "vgw-hub-vpn-uks"
    primary_virtual_network_gateway_vpn_public_ip_name_1         = "pip-vgw-hub-vpn-uks-01"
    primary_virtual_network_gateway_vpn_public_ip_name_2         = "pip-vgw-hub-vpn-uks-02"
    primary_private_dns_resolver_name                            = "pdr-hub-dns-uks"
    primary_bastion_host_name                                    = "bas-hub-uks"
    primary_bastion_host_public_ip_name                          = "pip-bastion-hub-uks"

    # Private DNS Zones primary
    primary_auto_registration_zone_name = "uks.azure.local"
